(function ($) {
    ...
    var alaa = new Swiper('.alaa', {
        slidesPerView: 1,
        spaceBetween: 60,
        loop: true,
        navigation: {
            nextEl: '.alaa .swiper-button-vertical-next',
            prevEl: '.alaa .swiper-button-vertical-prev',
        },
        thumbs: {
            swiper: zoomThumb
        }
    ...
    if($('[data-toggle-shipping]').length) {
        const $shippingToggle = $('[data-toggle-shipping]'),
            ...
            $shippingToggleTarget1 = $($shippingToggle[1].dataset.toggleShipping),
            $shippingShowHide = function() {
                ...
                if( $shippingToggle[1].checked ) {
                    $shippingToggleTarget1.slideDown();
                } else {
                    $shippingToggleTarget1.slideUp();
                }
            }
            console.log($shippingToggle[0]);
            console.log($shippingToggle[1]);
            console.log($shippingToggleTarget1);

        $shippingShowHide()
        $shippingToggle.on('click', function(){$shippingShowHide()});
    }
    /*----------------------------------------*/
