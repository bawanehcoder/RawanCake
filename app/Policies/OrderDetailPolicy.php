...
class OrderDetailPolicy
{
    ...
    {
        return $user->can('force_delete_item::report');
    }
    ...
    {
        return $user->can('force_delete_any_item::report');
    }
    ...
    {
        return $user->can('restore_item::report');
    }
    ...
    {
        return $user->can('restore_any_item::report');
    }
    ...
    {
        return $user->can('replicate_item::report');
    }
    ...
    {
        return $user->can('reorder_item::report');
    }
}
